    ...
    <FormProvider {...createMessageForm}>
      ...
      >
        <div className="relative z-0 w-full mb-5 group">
          <input id="name" {...register("name")} type="text" name="name" className="text-white block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none border-gray-600 dark:focus:border-violet-250 focus:outline-none focus:ring-0 focus:border-violet-250 peer font-thin" placeholder=" " required />
        ...
        <div className="relative z-0 w-full mb-5 group">
          <textarea {...register("message")} id="message" className="bg-transparent 
        ...
        <Button type="submit" className="m-6 hover:px-6 hover:py-4 hover:ease-in-out hover:duration-300 w-[300px] shadow-button">
          Send a message
          <IoMdSend />
        </Button>
      </form>
